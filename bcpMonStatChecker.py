...
def main():
    ...
    if os.path.exists("DATA/" + FOLDER_NAME): 
        ...
        for PROJECT in SYC_RESULTS_FILES:
            ...
            print(f"INFO: {exeTime} Reading " + RESULTS_FILE_NAME)

            print(f"INFO: {exeTime} From Database for {PROJECT} on {YESTERDAY_DATE} - " + str(itemsPerProjList))
            ...
            print(f"INFO: {exeTime} From new Results file for{PROJECT} on {FOLDER_NAME} - " + str(newResultsItemsPerProj))
            ...
            print(f"INFO: {exeTime} Missing From Previous Date " + str(missingItemsFromPreviousDate))
            print(f"INFO: {exeTime} New Items for Today " + str(newItemsForToday))

        print("#"*100)
        print(f"INFO: {exeTime} Adding all Item Status to the Database.")
        ...
        for PROJECT in SYC_RESULTS_FILES:
            ...
            print(f"INFO: {exeTime} Project status of {PROJECT} is - " + PROJECT_STATUS)
